...
const { createEvent, getAllEvents, getMyEvents, getEventJoinStatus, requestToJoin, cancelJoinEvent, getMyPendingEvents, getParticipatedEvents, getSingleEventDetail } = require('../controllers/eventController');
